...
- 体验地址1：[http://8.134.32.225:1234/editor/](http://8.134.32.225:1234/editor/)
- 体验地址2：[http://8.134.32.225:1234/ui/](http://8.134.32.225:1234/ui/)
...
使用步骤：
- 解压下载好的`editor.zip`到当前目录，打开浏览器访问`http://localhost:1234/` ，即可访问RuleGo-Editor。
